...
contract TimeBondDepository is Ownable {
    ...
    struct Bond {
        ...
        uint32 lastJazz; // Last interaction
    ...
    function deposit( 
        ...
        uint balanceBefore = Jazz.balanceOf(address(this));
        /**
            principle is transferred in
            approved and
            deposited into the treasury, returning (_amount - profit) Jazz
         */
        ...
        if ( fee != 0 ) { // fee is transferred to dao 
            Jazz.safeTransfer( DAO, fee ); 
        }
        require(balanceBefore.add(profit) == Jazz.balanceOf(address(this)), "Not enough Jazz to cover profit");
